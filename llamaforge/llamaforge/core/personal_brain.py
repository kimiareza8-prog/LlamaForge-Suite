...
class PersonalBrain:
    ...
    def resolve_training_base(self, model) -> dict:
        ...
        try:
            for _ in range(3):
                ...
                req = urllib.request.Request(url, headers={"User-Agent": "LlamaForge-Brain/0.34.3-hotfix", "Accept": "application/json"})
    ...
    def prepare_toolchain(self) -> None:
        ...
        req = urllib.request.Request(url, headers={"User-Agent": "LlamaForge-Brain/0.34.3-hotfix"})
